...
async def audio(message: types.Message): 
    await message.answer("Отправьте ссылку в музыку чтоб скачать её.") 
    await Download.download.set() 
 
@dp.message_handler(commands='video') 
async def audio(message: types.Message): 
    await message.answer("Отправьте ссылку на видео чтоб скачать её.") 
...
async def down_audio(message: types.Message, state: FSMContext): 
    await message.answer("Начало загрузки, ожидайте.....") 
